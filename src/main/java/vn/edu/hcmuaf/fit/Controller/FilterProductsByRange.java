...
@WebServlet(name = "filterProductsByRange", value = "/filterProductsByRange")
public class FilterProductsByRange extends HttpServlet {
    @Override
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        List<Product> list = productService.productsByRange(val);
        for (Product p : list) {
