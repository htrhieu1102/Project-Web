        ...
        <div class="content-wrapper">
          <div class="row">
            <div class="col-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Mẫu điền thông tin báo lỗi</h4>
                  <form class="forms-sample">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="exampleSelectGender" placeholder="Tên sản phẩm">
                      </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      <label for="exampleTextarea1">Mô tả lỗi</label>
                      <textarea class="form-control" id="exampleTextarea1" rows="4"></textarea>
                    </div>
                    <button type="submit" class="btn btn-primary me-2">Gửi đi</button>
