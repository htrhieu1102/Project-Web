                ...
                <div class="row row--form">
                  ...
                  <div class="col-12 col-md-7 form__content">
                    <div class="row row--form">
                      ...
                      <div class="col-12">
                        <textarea id="text" name="text" class="form__textarea" placeholder="Mô tả"></textarea>
                      </div>
                      ...
                      <div class="col-12">
                        <input type="text" class="form__input" placeholder="Nhà sản xuất">
                      </div>
                  ...
                  <div class="col-12">
                    <div class="row row--form">
                      <div class="col-12">
                        <button type="button" class="form__btn">Thêm</button>
                      </div>
                    </div>
                  </div>
