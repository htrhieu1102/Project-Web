          ...
          <div class="col-lg-4 mx-auto">
            <div class="auth-form-light text-left py-5 px-4 px-sm-5">
              ...
              <form class="pt-3">
                ...
                <div class="form-group">
                  <input type="email" class="form-control form-control-lg" id="exampleInputEmail1" placeholder="Địa chỉ email">
                </div>
                <div class="form-group">
                  <input type="password" class="form-control form-control-lg" id="exampleInputPassword1" placeholder="Mật khẩu">
                </div>
                <div class="form-group">
                  <input type="password" class="form-control form-control-lg" id="exampleInputConfirmPassWord1" placeholder="Xác nhận mật khẩu">
                </div>
                <div class="mb-4">
                ...
                <div class="mt-3">
                  <a class="btn btn-block btn-primary btn-lg font-weight-medium auth-form-btn" href="../../index.jsp">ĐĂNG KÝ</a>
                </div>
                <div class="text-center mt-4 font-weight-light">
                  Đã có tài khoản? <a href="../samples/login.jsp" class="text-primary">Đăng nhập ngay</a>
                </div>
              </form>
            </div>
          </div>
